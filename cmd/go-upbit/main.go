...
import (
	...
	"github.com/donghoon-khan/go-upbit/cmd/go-upbit/menu"
)
...
func main() {
	...
	a := app.NewWithID("go-upbit.demo")
	a.SetIcon(theme.FyneLogo())
	w := a.NewWindow("Upbit 자동매매 Demo")
	topWindow = w
...
func makeNav(setTutorial func(tutorial menu.Tutorial), loadPrevious bool) fyne.CanvasObject {
	a := fyne.CurrentApp()

	tree := &widget.Tree{
		ChildUIDs: func(uid string) []string {
			return menu.TutorialIndex[uid]
		},
		IsBranch: func(uid string) bool {
			children, ok := menu.TutorialIndex[uid]
